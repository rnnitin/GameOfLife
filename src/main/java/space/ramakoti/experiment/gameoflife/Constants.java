...
public class Constants {
	...
	static final int TEXT_HEIGHT = 60;
	...
	static final int NUM_CELLS_X_AXIS = (MAXX - 2 * BORDERGAP) / (CELLW + CELL_BORDER_THINKNESS) - 1;
	static final int NUM_CELLS_Y_AXIS = (MAXY - 2 * BORDERGAP) / (CELLH + CELL_BORDER_THINKNESS) - 1;

	static final int INIT_MAX_LIVE_CELLS_PERCENT = 10;
